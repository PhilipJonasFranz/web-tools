    ...
    <div>
        ...
        <div>
            <div style="position: relative;" class="d-flex pa-0">
                ...
                <v-card width="800" @drop.prevent="onDrop($event)" @dragover.prevent="dragover = true"
                    ...
                    <div class="center-card">
                        <v-card-text>
                            <v-icon :class="[dragover ? 'mt-2, mb-6' : 'mt-5']" size="60">
                                ...
                                <p>Drop your file(s) here, or click to select
                                    them.</p>
            ...
            <div v-if="isOnMobile" class="mt-5"></div>
            <div v-else class="mt-15"></div>

            <div v-if="getUploadedFiles.length > 0 || showGetStartedCard" class="mb-5">
                <p class="text-h4 mb-2 mt-3">Your Files</p>
                <FileList v-bind:file=true></FileList>
            </div>
        </div>
    </div>
</template>
